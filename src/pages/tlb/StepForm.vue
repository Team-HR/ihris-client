...
export default {
  ...
  computed: {
    ...mapGetters({
      editedItem_vuex: "tlb/getEditedItem",
      editedItemIndex: "tlb/getEditedIndex"
    })
  },
  methods: {
    search_add() {
    ...
    ...mapActions({
      control_search: "tlb/control_search",
      doSave: "tlb/doSave",
      reload: "tlb/reload",
      setCompleted: "tlb/setCompleted"
    })
  }
};
</script>
