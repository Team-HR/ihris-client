...
export default {
  ...
  computed: {
    ...mapGetters({
      editedItem_vuex: "plantilla_jocontracts/getEditedItem",
      editedItemIndex: "plantilla_jocontracts/getEditedIndex"
    })
  },
  methods: {
    search_add() {
    ...
    ...mapActions({
      control_search: "plantilla_jocontracts/control_search",
      doSave: "plantilla_jocontracts/doSave",
      reload: "plantilla_jocontracts/reload",
      setCompleted: "plantilla_jocontracts/setCompleted"
    })
  }
};
</script>
